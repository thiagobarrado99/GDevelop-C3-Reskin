...
export const getBrowserSWPreviewRootUrl = (): string => {
  ...
  // c3: the editor may live under a sub-path (/editor/) - the service worker
  // only controls URLs under its own scope.
  return `${origin}${process.env.PUBLIC_URL || ''}/browser_sw_preview`;
};
