...
### A2. Keyboard / Mouse / Touch / Audio / Gamepad… as object tiles
...
### A5. Selected object / layer rows unreadable
...
### A6. Objects and families project-wide by default
...
### A7. New layers without the two 3D lights
...
### B4. Project root row + layout rows select in the bar
