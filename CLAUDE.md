...
4. Phase 4 layout view: done — context menus, double-click insert, status bar, panel order. Left (TODO): dark surround outside the layout frame, Z-order bar, Align ▸.
5. Phase 5 polish: shortcuts done, tutorial banners hidden, README banner. Left: animation editor look, examples. Then: the 10 behaviours with no port (own events-based extensions), icons once the user copies them in.
