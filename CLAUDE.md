...
5. Phase 5 polish: done (shortcuts, tutorial banners hidden, README banner, example browser; animation editor stays GDevelop's). Behaviours with no port: done as own extensions. Left: icons once the user copies them in, and the 2026-09-20 briefing in `TODO.md`.
