...
## Icons still missing (for the user to draw, 2026-09-20)
GDevelop-only items shown as extra tiles keep GDevelop's icon. File name = pt-BR label slugged, dropped in `public/res/c3-icons/{objects,behaviors}/` and mapped in `Utils/C3Icons.js` (types not in the tables need a row in `objectSlugs` / `behaviorSlugs`).
- Objects (16): Emissor de partículas 3D · Luz direcional 3D · Luz pontual 3D · Joystick multitouch · Botão rotulado · Barra de recurso (contínua) · Barra de recurso (unidades separadas) · Controle deslizante · Interruptor de alternância · Diálogo de fim de jogo · Contador de pontuação animado · Two choices dialog box · Avatar multiplayer · Barra de avaliação de estrelas · Configurações de volume · Salas de espera personalizadas para multijogador
- Behaviours (108, community extensions): Exibidor de FPS · Animador de folha de sprite JSON · Animador de folha de sprites horizontal · Animador de folha de sprites vertical · Pintor de caminhos · Paralaxe horizontal para um Sprite Tiled · Paralaxe vertical para um Sprite Tiled · Câmera suave do plataforma · Viewport rolável · Câmera de terceira pessoa · Giro 3D · Tonificação de cor em flash · Agitar 3D · Balançar · Pintor de efeito e transição de flash · Shadow clone emitter · Efeito de flash · Opacidade esfumaçada (desvanecer) suavemente · YSort · Pintor de quadrados marchantes · Ondas de choque estelares · Agitar objeto (posição, ângulo) · Agitar objeto (posição, ângulo, escala) · Efeito de profundidade · Painel · Contador Rolante · Mover para a visualização · Onda de choque de elipse · Mapeador de controlador multitouch para plataforma de personagem · Mapeador de controle de plataforma · Mapeador de controlador multitouch para visão de cima · Mapeador de gamepad de cima para baixo · Mapeador de teclado de plataforma 3D · Mapeador de controlador multitouch para plataforma 3D de personagem · Mapeador de controle de plataforma 3D (×2) · Mapeador de teclado de atirador 3D · Mapeador de controlador multitouch para atirador 3D · Mapeador de mouse de câmera em primeira pessoa · Mapeador de controlador multitouch para câmera de primeira pessoa · Mapeador de controle de câmera em primeira pessoa · 3D car keyboard mapper · 3D car multitouch controller mapper · 3D car gamepad mapper · Remapeador de teclado top-down · Cursor · Botão multitouch · Código Konami · Objeto ajustável com pinça · Mapeador de teclado de plataforma · Repetir a cada X segundos · Interruptor de alternância · Tween de efeito de objeto de botão · Objeto arrastável cancelável · Tween de escala do botão · Controle deslizante arrastável · Animação do botão · Caixa de seleção · Cursor customizado quando hover · Digitando texto automaticamente · Tween de tonalidade de cor do botão · Estados de botão · Efeitos do objeto de botão · Saúde · Disparar balas · Pilha de objetos · Gerador de objetos · Rastreador ocioso · Disparo de bala 3D · Está na tela · Localização do caminho do link · Personagem de física 3D · Personagem de navegação (baseado em navmesh) · Piso/obstáculo para navegação (baseado em navmesh) · Animador de personagem físico 3D · Tempo do coiote e pulo no ar para 3D · Movimento linear por ângulo · Movimento de Vai e Vem Temporizado · Pulo na parede · Envolver a tela (objetos físicos) · Movimento perfeitamente alinhado com pixels grandes · Carro físico · Personagem de plataforma perfeitamente alinhado com pixels grandes · Movimento em uma curva (baseado na duração) · Top-down movement animator · Movimento para Trás e para Frente (espelhado) · Arrastável (para objetos físicos) · Orbiting object emitter · Saltitar · Deslocamento horizontal · Tempo de coyote e pulo no ar · Impor velocidade máxima de rotação (física) · Movimento linear · Pilha de configuração de personagem de plataforma · Movimento retangular · Impor velocidade máxima de movimento (física) · Animador de personagem de plataforma · Movimento elíptico 3D · Avaliador de trajetória do platformer · Movimento de Boids · Impor velocidade máxima de movimento · Bumerangue · Movimento em uma curva (baseado na velocidade) · Virar para frente · Mergulho rápido · Objeto Multiplayer
